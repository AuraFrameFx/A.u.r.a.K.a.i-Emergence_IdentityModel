...
dependencies {
    ...
    implementation("org.jetbrains.kotlin:compose-compiler-gradle-plugin:2.3.0-RC2")
    implementation("org.jetbrains.kotlin:kotlin-serialization:2.3.0-RC2")
...
dependencies {
    ...
    add("implementation", "org.jetbrains.kotlin:kotlin-gradle-plugin:2.3.0-RC2")
}
// ═══════════════════════════════════════════════════════════════════════════
